...
export default function NewsList() {
    ...
    const openViewModal = (newsId: string) => {
        setViewModal({
            isOpen: true,
            newsId,
        })
    ...
    return (
        <div className="bg-gray-50">
                                        ...
                                        {news.map((article) => (
                                            <tr key={article._id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    >
                                                        <DropdownItem onClick={() => openViewModal(article._id)}>
                                                            <FiEye className="mr-2 h-4 w-4" />
                                                            View
                                                        </DropdownItem>
                                                        <DropdownItem onClick={() => openEditModal(article)}>
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            >
                                                ...
                                                <DropdownItem onClick={() => openDeleteModal(article)} className="text-red-600 hover:bg-red-50">
                                                    <FiTrash2 className="mr-2 h-4 w-4" />
                                                    Delete
                                                </DropdownItem>
                                            </Dropdown>
            ...
            {deleteModal.isOpen && deleteModal.news && (
                <DeleteModal
            ...
            {viewModal.isOpen && viewModal.newsId && (
                <NewsViewOffcanvas isOpen={viewModal.isOpen} onClose={closeViewModal} newsId={viewModal.newsId} />
            )}
        </div>
    )
}
